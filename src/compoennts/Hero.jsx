    ...
    <div className="bg-gray-50 min-h-screen text-gray-800">
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex space-x-1 sm:space-x-2">
            <button
              ...
              className="px-2 py-1 sm:px-3 sm:py-1 bg-gray-200 rounded text-sm"
            >
              UZ
            </button>
            <button
      ...
      <section className="max-w-6xl mx-auto px-4 py-8 sm:py-16">
        ...
        <ul className="space-y-3">
          ...
          <li>📘 {t("publications.book3")}</li>
          <li>📗 {t("publications.book4")}</li>
          <li>📗 {t("publications.book5")}</li>
        </ul>

        <p className="mt-6">{t("publications.note")}</p>
      </section>
      ...
      <section className="bg-gray-100 py-8 sm:py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <ul className="space-y-3">
            ...
            <li>🏅 {t("awards.item2")}</li>
            <li>🏅 {t("awards.item3")}</li>
          </ul>
        </div>
      </section>
    </div>
